...
IEX_SMALL = settings.DATA_DIRECTORY / 'iex_tops_small.sqlite3'

db = sqlite3.connect(IEX_PATH)
db_t = sqlite3.connect(IEX_SMALL)

db_t.execute('DROP INDEX IF EXISTS iex_trade_reports_2000_idx;')
db_t.execute('DROP TABLE IF EXISTS iex_trade_reports_2000;')
db_t.execute('DROP TABLE IF EXISTS iex_meta_2000;')
...
db_t.execute('CREATE INDEX iex_trade_reports_2000_idx ON iex_trade_reports_2000(day, symbol);')
