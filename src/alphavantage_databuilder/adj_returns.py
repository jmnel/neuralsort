...
#            m = len(data[s]) - 1
        ...
        try:
            db_clean.drop_table('adj_returns_clean')

        except sqlite3.OperationalError as e:
            print('WARNING: Table \'adj_returns_clean\' doesn\'t exist.')
        ...
        db_clean.create_table('adj_returns_clean', cols_props)
        ...
        db_clean.insert('adj_returns_clean', cols, values)
        db_clean.commit()
        db_clean.close()
...
print(data_path)
builder = AdjReturnsBuilder(data_path)
