...
#    tickers_to_keep = {qdl_code: sid for symbol,
#                       sid, qdl_code in tickers_to_keep}

#    for qdl_code, values in tickers_to_keep.items():
#        print(qdl_code)
...
#            if idx % 1e5 == 0:
#                print(f'\t\tParsing row {idx+1} of ')

#            qdl_code, date, o, h, l, c, v, div, sp, o_adj, h_adj, l_adj, c_adj, v_adj = row

#            if qdl_code in tickers_to_keep.keys():
#                print(qdl_code)

#                data.append((tickers_to_keep[qdl_code], date, o, h, l,
#                             c, v, div, sp, o_adj, h_adj, l_adj, c_adj, v_adj))
