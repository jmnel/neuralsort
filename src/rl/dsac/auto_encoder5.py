...
#        self.hidden = nn.Linear(HIDDEN, 512 * 978)
#        self.hidden = nn.Linear(256 * PRE_HIDDEN, HIDDEN)
...
class Autoencoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder = Encoder(self.skip_list)
        self.decoder_r = RDecoder(self.skip_list)
